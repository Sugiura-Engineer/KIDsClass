...
//親から渡されたProps(bool値とref用HTMLタグ)を持つ.
//boolがtruになったら実行する.
export default function FileDropOverlay({target,show, onClose, onFileLoaded}:Props){  //const target= props.targetの簡略構文.引数propsはProps型.
